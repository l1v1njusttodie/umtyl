...
public final class ActivityResultBinding implements ViewBinding {
  ...
  private ActivityResultBinding(@NonNull LinearLayout rootView, @NonNull Button btnFinish,
      @NonNull ImageView ivTrophy, @NonNull TextView tvName, @NonNull TextView tvResult,
  ...
  public static ActivityResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityResultBinding((LinearLayout) rootView, btnFinish, ivTrophy, tvName,
          tvResult, tvScore);
    }
